...
Version  : 0.6.3
Release  : 2
URL      : https://files.pythonhosted.org/packages/28/15/f6ff4661cbb7df89f762a6e79a1b48c1ecf81cceed0740ae849791528d87/pyroute2.core-0.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/28/15/f6ff4661cbb7df89f762a6e79a1b48c1ecf81cceed0740ae849791528d87/pyroute2.core-0.6.3.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.3
cd %{_builddir}/pyroute2.core-0.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622561222
...
cp %{_builddir}/pyroute2.core-0.6.3/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.3/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
