...
Version  : 0.6.4
Release  : 3
URL      : https://files.pythonhosted.org/packages/8c/e0/93c7d6ff810cd15630e92ef13368ce3a8e0f044110c6584e0f7156f110e1/pyroute2.core-0.6.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/8c/e0/93c7d6ff810cd15630e92ef13368ce3a8e0f044110c6584e0f7156f110e1/pyroute2.core-0.6.4.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.4
cd %{_builddir}/pyroute2.core-0.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623080230
...
cp %{_builddir}/pyroute2.core-0.6.4/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.4/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
